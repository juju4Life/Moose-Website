...
To activate your index dashboard add the following to your settings.py::
    ADMIN_TOOLS_INDEX_DASHBOARD = 'Goat.dashboard.CustomIndexDashboard'

And to activate the app index dashboard::
    ADMIN_TOOLS_APP_INDEX_DASHBOARD = 'Goat.dashboard.CustomAppIndexDashboard'
"""
...
class CustomIndexDashboard(Dashboard):
    """
    Custom index dashboard for Goat.
    """
...
class CustomAppIndexDashboard(AppIndexDashboard):
    """
    Custom app index dashboard for Goat.
    """
