...
class Client(object):
    ...
    def _get(self, url, query=None, timeout=10, fix_request=False, as_json=False, error_retries=3):
    ...
    def fetchImageUrl(self, image_id):
        ...
        if url is None:
            pass #raise FBChatException('Could not fetch image url from: {}'.format(j))
        return url
    ...
    def listen(self, markAlive=True, end_time=60):
        ...
        while self.listening and self.doOneListen(markAlive) and time.time() < t_end:
            pass
